...
// 구조분해 할당의 부모 App 컴포넌트가 전달한 함수 객체를 받는다
...
const ProductForm = ({ onSubmit }) => {
  ...
  // ajax axios 를 이용하는 addProduct 함수를 실행하기 위한 함수를 정의
  ...
  // 폼데이터 상태관리를 위한 함수
  // react는 앝은 복사이기 때문에 요소들도 다 가져와서 새로운 객체를 만들고 싶으면
  // ... 구조분해를 사용해야 한다.
  const handleChange = (e) => {
    // e : 이벤트 객체
    setFormData({
      // setFormData : react state hook 함수 : 상태 변경시 호출하는 함수 -> react 반영(리렌더링)
