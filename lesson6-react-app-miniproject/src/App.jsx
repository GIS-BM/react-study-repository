...
function App() {
  // state 상태 관리 : useState Hook을 이용
  // selectedTopic : 사용자가 어떤 탭을 선택했는지 탭제목을 저장,
  // setSelectedTopic : 사용자가 탭을 선택했을때 React에 탭 정보 변경을 알려서 리렌더링 하는 함수
  const [selectedTopic, setselectedTopic] = useState();
  // 탭 버튼 클릭시 호출되는 함수 (탭 버튼 이벤트 핸들러)
          ...
          <ul>
            ...
            */}
            {/* 스프레드 연산자로 효율적으로 props 전달, 화살표 함수를 간략하게 표현 {}가 아니라 () 형태로
                {...conceptItem} 표현은 image={conceptItem.title} title={conceptItem.title}
