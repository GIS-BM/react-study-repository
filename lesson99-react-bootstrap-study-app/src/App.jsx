...
function App() {
  return (
    ...
    <Container className="d-flex flex-column justify-content align-items-center vh-100">
      <header className="text-center">
        {/* d-none : display none 기본적으로 요소를 숨김
            d-md-block : md 768px 태블릿 이상의 화면에서만 h1 문자열이 보이도록 설정1
        */}
        <div className="d-none d-md block">
          <h1>리액트 부트스트랩 예제</h1>
        </div>
        {/* md 미만에서만 보이고 md 이상에서는 안보이게 한다. */}
        <div className="d-md-none">
          <h3>리액트 부트스트랩 예제</h3>
        </div>
        {/* 
            부트 스트랩 그리드 : 행 row와 열 col로 구성
            {1} => props을 통한 반응형 설정
